...
import com.app.myfoottrip.api.CommentApi
import com.app.myfoottrip.util.NetworkResult

private const val TAG = "CommentRepository_마이풋트립"
class CommentRepository {
    private val commentService = Application.retrofit.create(CommentApi::class.java)
    private val headerCommentService = Application.headerRetrofit.create(CommentApi::class.java)
